...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // File shared by browser and server
...
var app = (0, _express2.default)(); //THIS FILE IS THE EXPRESS LOGIC

app.use('/api', (0, _expressHttpProxy2.default)('http://react-ssr-api.herokuapp.com', {
    // This part is strictly for user with THIS application. Not your own personal application
...
app.get('*', function (req, res) {
    // The 'req' contains the url the user is trying to access
...
exports.default = {
    ...
    // the routes in route.routes is found in Routes.js line 12
